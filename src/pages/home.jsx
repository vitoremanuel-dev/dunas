const Home = () => {
  return (
    <>
      ...
      <div className="w-full h-[25rem] flex flex-col gap-y-10 justify-center items-center text-center px-5 sm:px-20">
      ...
      <div className="w-full h-[30rem] flex flex-col bg-[#e4cc68] gap-y-10 justify-center items-center text-center px-5 sm:px-20">
        <h1 className="font-semibold text-2xl sm:text-3xl">SOBRE O DUNAS MOTEL</h1>
